...
const aiRoadmapPhases = [
    {
        ...
        resources: [
            { label: "Pragmatic Thinking & Learning", sub: "① READ FIRST · all 8 chapters · focus on ch 1–5 (brain modes, learning deliberately) · ch 6–8 are bonus · 2 hours · YOU OWN THIS", type: "Book", url: "https://pragprog.com/titles/ahptl/pragmatic-thinking-and-learning/" },
            { label: "Automate the Boring Stuff with Python", sub: "② START HERE · chapters 1–11 (Python basics, lists, dicts, strings, regex, files, web scraping) · do every project · skip ch 12–19 · YOU OWN THIS · FREE ONLINE at automatetheboringstuff.com", type: "Book", url: "https://automatetheboringstuff.com/" },
            { label: "Fluent Python", sub: "③ REFERENCE · Part 1 ch 1–3 (data model, sequences, dicts) + Part 2 ch 7–9 (functions, decorators) · read after Automate · BUY: O'Reilly or Amazon", type: "Book", url: "https://www.oreilly.com/library/view/fluent-python-2nd/9781492056348/" },
            { label: "Kaggle Learn", sub: "④ IN PARALLEL · complete Python track (7 lessons) + Pandas track (6 lessons) + Intro to SQL (6 lessons) · ~12 hours total · free", type: "Free", url: "https://www.kaggle.com/learn" },
        ],
    },
    {
        num: "02",
        ...
        resources: [
            { label: "ML Specialization", sub: "① START HERE · all 3 courses in full · Course 1: supervised learning · Course 2: advanced algorithms · Course 3: unsupervised + recommenders · ~60 hours · audit free", type: "Course", url: "https://www.coursera.org/specializations/machine-learning-introduction" },
            { label: "Hands-On ML", sub: "② IN PARALLEL · Part 1 ch 1–8 (ML fundamentals through ensemble methods) alongside Ng · Part 2 ch 9–11 (neural nets) after Ng week 4 · BUY: O'Reilly or Amazon", type: "Book", url: "https://www.oreilly.com/library/view/hands-on-machine-learning/9781098125967/" },
            { label: "fast.ai", sub: "③ AFTER WEEK 3 · Lessons 1–7 (practical deep learning) · do all notebooks in Kaggle · start after Ng week 3 so you have theory context · free", type: "Free", url: "https://course.fast.ai/" },
            { label: "Math for ML Specialization", sub: "④ AFTER NG · all 3 courses: Linear Algebra → Multivariate Calculus → PCA · only start after finishing Andrew Ng entirely · audit free", type: "Course", url: "https://www.coursera.org/specializations/mathematics-machine-learning" },
        ],
    },
    {
        num: "03",
        ...
        resources: [
            { label: "Deep Learning Specialization", sub: "① MAIN COURSE · all 5 courses · focus on: neural nets basics, CNNs, sequence models, transformers · ~80 hours · audit free on Coursera", type: "Course", url: "https://www.coursera.org/specializations/deep-learning" },
            { label: "Zero to Hero", sub: "② IN PARALLEL · all 7 videos in order: micrograd → makemore → GPT from scratch · do every exercise in the notebooks · ~15 hours · free on YouTube", type: "Free", url: "https://karpathy.ai/zero-to-hero.html" },
            { label: "The Deep Learning Book", sub: "③ REFERENCE · ch 1–6 (math foundations + ML basics) + ch 9–10 (CNNs + RNNs) · use as reference alongside the specialization · FREE ONLINE at deeplearningbook.org", type: "Free", url: "https://www.deeplearningbook.org/" },
            { label: "Anthropic Docs", sub: "④ AFTER KARPATHY · read in order: API reference → Messages → Prompt engineering → Tool use → Vision → Embeddings · ~6 hours · free", type: "Free", url: "https://docs.anthropic.com/" },
        ],
    },
    {
        num: "04",
        ...
        resources: [
            { label: "Anthropic Cookbook", sub: "① START HERE · work through all notebooks in order · focus on: basic API usage, tool use, RAG, agents, evals · run every notebook yourself · free on GitHub", type: "Free", url: "https://github.com/anthropics/anthropic-cookbook" },
            { label: "AI Agents in LangGraph", sub: "③ AFTER BASICS · all lessons in order · ~3 hours · focus on: agent state, tool nodes, human-in-the-loop, multi-agent patterns · free", type: "Free", url: "https://learn.deeplearning.ai/courses/ai-agents-in-langgraph" },
            { label: "AI Engineering", sub: "④ EVENINGS · ch 1–5 (foundations, RAG, agents, evals) during this phase · ch 6–9 (production) in Phase 05 · buy the book", type: "Book", url: "https://www.oreilly.com/library/view/ai-engineering/9781098166298/" },
            { label: "Prompt Engineering for Devs", sub: "② WEEK 1 · all 9 lessons in order · 2 hours total · do this in your first week before anything else · free", type: "Free", url: "https://learn.deeplearning.ai/courses/chatgpt-prompt-eng-for-devs" },
        ],
    },
    {
        num: "05",
        ...
        resources: [
            { label: "MLOps Specialization", sub: "① MAIN COURSE · all 4 courses in order: ML pipelines → data validation → model deployment → monitoring · ~50 hours · audit free", type: "Course", url: "https://www.coursera.org/specializations/machine-learning-engineering-for-production-mlops" },
            { label: "Full Stack Deep Learning", sub: "② IN PARALLEL · all lectures in order · focus on: project setup, infra, CI/CD for ML, deployment, testing · ~15 hours · free", type: "Free", url: "https://fullstackdeeplearning.com/course/" },
            { label: "Designing ML Systems", sub: "③ EVENINGS · all 11 chapters · ch 1–5 done in Phase 04 · ch 6–11 (feature engineering, training pipeline, serving, monitoring) here · BUY: O'Reilly or Amazon", type: "Book", url: "https://www.oreilly.com/library/view/designing-machine-learning/9781098107956/" },
            { label: "Weights & Biases Courses", sub: "④ AFTER WEEK 2 · complete: Effective MLOps course (all modules) + LLM Engineering course (all modules) · ~6 hours total · free", type: "Free", url: "https://www.wandb.courses/" },
        ],
    },
    {
        num: "06",
        ...
        resources: [
            { label: "Braintrust", sub: "① WHEN SHIPPING · no fixed curriculum · set up a project, define eval criteria, run your first suite · follow their Getting Started docs · free tier", type: "Free", url: "https://www.braintrustdata.com/" },
            { label: "LlamaIndex Docs", sub: "② PROJECT PHASE · read: Getting Started → Documents & Nodes → Indexing → Querying → Evaluating · use as reference while building · free", type: "Free", url: "https://docs.llamaindex.ai/" },
            { label: "Full Stack Deep Learning", sub: "③ IF NOT DONE · all lectures in order if you skipped in P05 · focus on shipping and product thinking · ~15 hours · free", type: "Free", url: "https://fullstackdeeplearning.com/course/" },
            { label: "Latent Space Podcast", sub: "④ ONGOING · no fixed order · 1–2 episodes per week · focus on: production AI, evals, agent systems · free", type: "Free", url: "https://www.latent.space/" },
        ],
    },
];
...
const fsRoadmapPhases = [
    {
        ...
        resources: [
            { label: "JavaScript: The Hard Parts v2", sub: "① START HERE · all 4 sections: JS Principles → Closures → Async → OOP · do every coding challenge · ~6 hours · Frontend Masters", type: "Course", url: "https://frontendmasters.com/courses/javascript-hard-parts-v2/" },
            { label: "Total TypeScript", sub: "③ AFTER JS SOLID · free tutorials: all 5 tutorial series in order · paid: Beginners → Pro TypeScript workshops · start when JS feels comfortable", type: "Course", url: "https://www.totaltypescript.com/tutorials" },
            { label: "You Don't Know JS", sub: "② IN PARALLEL · Book 1: Get Started (all 4 ch) · Book 2: Scope & Closures (all 6 ch) · Book 3: Objects & Classes (all 4 ch) · FREE ONLINE at github.com/getify/You-Dont-Know-JS", type: "Book", url: "https://github.com/getify/You-Dont-Know-JS" },
            { label: "JavaScript & jQuery", sub: "④ AS NEEDED · ch 1–10 (core JS) · dip in when a concept in YDKJS doesn't click visually · don't read cover to cover · YOU OWN THIS", type: "Book", url: "https://www.amazon.com/JavaScript-JQuery-Interactive-Front-End-Development/dp/1118531647" },
        ],
    },
    {
        num: "02",
        ...
        resources: [
            { label: "React – The Complete Guide", sub: "② MAIN COURSE · sections 1–14 · focus on: Components, Props, State, Hooks, useEffect, Context · skip Redux section (legacy) · ~25 hours · Udemy", type: "Course", url: "https://www.udemy.com/course/react-the-complete-guide-incl-redux/" },
            { label: "Next.js & React – Complete Guide", sub: "③ AFTER REACT · sections covering App Router, Server Components, Data Fetching, Caching, Auth, Deployment · skip Pages Router sections · ~20 hours · Udemy", type: "Course", url: "https://www.udemy.com/course/nextjs-react-the-complete-guide/" },
            { label: "TanStack Query Docs", sub: "④ AFTER HOOKS · read: Overview → Queries → Mutations → Pagination → Optimistic Updates · ~3 hours · skip framework-specific sections for now · free", type: "Free", url: "https://tanstack.com/query/latest/docs/framework/react/overview" },
            { label: "React Official Docs", sub: "① START HERE · Learn React section in full: Describing the UI → Adding Interactivity → Managing State → Escape Hatches · do every challenge · ~8 hours · free", type: "Free", url: "https://react.dev/learn" },
        ],
    },
    {
        num: "03",
        ...
        resources: [
            { label: "Node.js: The Complete Guide", sub: "① MAIN COURSE · watch: Node basics → Express → REST APIs → Authentication → File uploads → skip GraphQL + Deno sections · ~25 hours · Udemy", type: "Course", url: "https://www.udemy.com/course/nodejs-the-complete-guide/" },
            { label: "API Design in Node.js", sub: "② IN PARALLEL · all sections in order · focus on: route design, middleware, auth patterns, error handling · ~4 hours · Frontend Masters", type: "Course", url: "https://frontendmasters.com/courses/api-design-nodejs-v4/" },
            { label: "Zod Docs", sub: "③ AS NEEDED · read: Getting Started → Primitives → Objects → Strings/Numbers → Error handling · ~2 hours · apply immediately in your API · free", type: "Free", url: "https://zod.dev/" },
            { label: "Head First Design Patterns", sub: "④ EVENINGS · ch 1 Strategy, 2 Observer, 3 Decorator, 4 Factory, 5 Singleton · map directly to backend patterns · YOU OWN THIS (no need to buy)", type: "Book", url: "https://www.oreilly.com/library/view/head-first-design/9781492077992/" },
        ],
    },
    {
        num: "04",
        ...
        resources: [
            { label: "Complete SQL & Databases Bootcamp", sub: "① MAIN COURSE · all sections through PostgreSQL · focus on: SELECT, JOINs, GROUP BY, subqueries, indexes, transactions · skip MongoDB section · ~20 hours · Udemy", type: "Course", url: "https://www.udemy.com/course/complete-sql-databases-bootcamp-zero-to-mastery/" },
            { label: "Prisma Docs", sub: "② IN PARALLEL · read: Getting Started → CRUD → Relations → Migrations → Filtering/Sorting · ~4 hours · start after week 2 of SQL course · free", type: "Free", url: "https://www.prisma.io/docs/getting-started" },
            { label: "Learning SQL", sub: "③ REFERENCE · ch 1–10 (querying) + ch 13 (indexes) + ch 15 (metadata) · BUY: O'Reilly or Amazon", type: "Book", url: "https://www.oreilly.com/library/view/learning-sql-3rd/9781492057604/" },
            { label: "Supabase Docs & Tutorials", sub: "④ PROJECT PHASE · read: Database → Auth → Storage → Edge Functions · use as backend for your phase project · reference as you build, not upfront · free", type: "Free", url: "https://supabase.com/docs" },
        ],
    },
    {
        num: "05",
        ...
        resources: [
            { label: "Docker for Web Developers", sub: "① MAIN COURSE · all sections · focus on: containers, images, Compose, volumes, networking, CI/CD integration · skip Swarm + K8s sections · ~10 hours · Udemy", type: "Course", url: "https://www.udemy.com/course/docker-mastery/" },
            { label: "Test-Driven Development", sub: "② IN PARALLEL · Part 1 ch 1–17 (Money example) + Part 2 ch 18–24 (xUnit) · skip Part 3 · YOU OWN THIS (no need to buy)", type: "Book", url: "https://www.amazon.com/Test-Driven-Development-Kent-Beck/dp/0321146530" },
            { label: "The Art of Unit Testing", sub: "③ ALONGSIDE TDD · Parts 1–3 ch 1–8 (unit test → test doubles → isolation) · Part 4 optional · YOU OWN THIS (no need to buy)", type: "Book", url: "https://www.artofunittesting.com/" },
            { label: "Vercel Docs", sub: "④ WHEN DEPLOYING · read: Getting Started → Projects → Deployments → Environment Variables → Domains · reference as you deploy · ~2 hours · free", type: "Free", url: "https://vercel.com/docs" },
        ],
    },
    {
        num: "06",
        ...
        nonneg: "AI Engineering by Chip Huyen — all 9 chapters cover to cover · bridges full-stack + AI perfectly · BUY: O'Reilly or Amazon",
        resources: [
            { label: "Vercel AI SDK Docs", sub: "① START HERE · read: Getting Started → Generating Text → Streaming → Tool Calling → RAG · implement one AI feature in your project · ~4 hours · free", type: "Free", url: "https://sdk.vercel.ai/docs" },
            { label: "LangChain for LLM Apps", sub: "② SHORT COURSE · all lessons in order · ~2 hours · gives you LangChain context even if you end up using LlamaIndex instead · free", type: "Free", url: "https://learn.deeplearning.ai/courses/langchain" },
            { label: "AI Engineering", sub: "③ MUST READ · all 9 chapters cover to cover · bridges full-stack + AI engineering perfectly · the most important book for this phase · BUY: O'Reilly or Amazon", type: "Book", url: "https://www.oreilly.com/library/view/ai-engineering/9781098166298/" },
            { label: "Playwright Docs", sub: "④ IN PARALLEL · read: Getting Started → Writing Tests → Test Assertions → Page Object Model → CI · ~5 hours · your QA background makes this take days not weeks · free", type: "Free", url: "https://playwright.dev/docs/intro" },
        ],
    },
];
...
const beginnerRoadmapPhases = [
    {
        ...
        resources: [
            { label: "The Odin Project", sub: "① MAIN PATH · follow Full Stack JavaScript path in full · do every project, skip nothing · Foundation → JavaScript → React sections · ~200 hours total · free", type: "Free", url: "https://www.theodinproject.com/paths/full-stack-javascript" },
            { label: "JavaScript.info", sub: "② REFERENCE · Part 1 all chapters (JavaScript fundamentals) · use alongside Odin Project when something doesn't click · do all tasks · free", type: "Free", url: "https://javascript.info/" },
            { label: "Eloquent JavaScript", sub: "③ SUPPLEMENT · ch 1–6 (values, functions, objects, data structures) · read after each Odin Project section for deeper theory · FREE ONLINE at eloquentjavascript.net", type: "Book", url: "https://eloquentjavascript.net/" },
            { label: "JavaScript & jQuery", sub: "④ VISUAL AID · ch 1–10 · dip in when a concept doesn't click visually · don't read cover to cover · best used alongside Odin Project · YOU OWN THIS", type: "Book", url: "https://www.amazon.com/JavaScript-JQuery-Interactive-Front-End-Development/dp/1118531647" },
        ],
    },
    {
        num: "02",
        ...
        resources: [
            { label: "React Official Docs", sub: "① START HERE · Learn React in full: Describing UI → Interactivity → Managing State → Escape Hatches · do every challenge · ~8 hours · free", type: "Free", url: "https://react.dev/learn" },
            { label: "React – The Complete Guide", sub: "② MAIN COURSE · sections 1–14 · Components, Props, State, Hooks, useEffect, Context · skip Redux section · ~25 hours · Udemy", type: "Course", url: "https://www.udemy.com/course/react-the-complete-guide-incl-redux/" },
            { label: "TanStack Query Docs", sub: "③ AFTER HOOKS · Overview → Queries → Mutations → reference as needed · ~3 hours · use from your first real project onwards · free", type: "Free", url: "https://tanstack.com/query/latest/docs/framework/react/overview" },
            { label: "Tailwind CSS Docs", sub: "④ IN PARALLEL · read: Core Concepts → Layout → Flexbox/Grid → Typography → Responsive Design · use alongside every project · free", type: "Free", url: "https://tailwindcss.com/docs/installation" },
        ],
    },
    {
        num: "03",
        ...
        resources: [
            { label: "Next.js Official Docs", sub: "① START HERE · do the full Dashboard App tutorial (16 chapters) · then read Routing + Rendering + Data Fetching docs · ~10 hours · free", type: "Free", url: "https://nextjs.org/learn" },
            { label: "Next.js & React – Complete Guide", sub: "② MAIN COURSE · sections on App Router, Server Components, Data Fetching, Auth, Deployment · skip Pages Router sections · ~20 hours · Udemy", type: "Course", url: "https://www.udemy.com/course/nextjs-react-the-complete-guide/" },
            { label: "Fireship YouTube", sub: "③ SUPPLEMENT · search 'Next.js', 'React', 'Supabase' on the channel · watch the 100-second concept videos before diving deep · free", type: "Free", url: "https://www.youtube.com/@Fireship" },
            { label: "shadcn/ui Docs", sub: "④ AS NEEDED · Introduction → Installation → Theming → then look up components as you need them · don't read upfront · free", type: "Free", url: "https://ui.shadcn.com/docs" },
        ],
    },
    {
        num: "04",
        ...
        resources: [
            { label: "Supabase Docs", sub: "① START HERE · read: Database → Auth → Storage → Realtime · follow the quickstart guides first · use as your backend from day one · free", type: "Free", url: "https://supabase.com/docs" },
            { label: "Prisma Getting Started", sub: "② IN PARALLEL · Getting Started → CRUD → Relations → Migrations · ~3 hours · read alongside building your first full-stack project · free", type: "Free", url: "https://www.prisma.io/docs/getting-started" },
            { label: "Complete SQL Bootcamp", sub: "③ MAIN COURSE · all sections through PostgreSQL · SELECT, JOINs, GROUP BY, subqueries · skip MongoDB · ~20 hours · Udemy", type: "Course", url: "https://www.udemy.com/course/complete-sql-databases-bootcamp-zero-to-mastery/" },
            { label: "Node.js Crash Course", sub: "④ QUICK WIN · watch the full crash course (~90 mins) · gives you enough Node/Express to understand what Supabase is abstracting · free", type: "Free", url: "https://www.youtube.com/watch?v=fBNz5xF-Kx4" },
        ],
    },
    {
        num: "05",
        ...
        resources: [
            { label: "The Freelance Bible", sub: "① READ NOW · all chapters · focus on: pricing, finding clients, contracts, communication, managing scope · YOU OWN THIS (no need to buy)", type: "Book", url: "https://www.dk.com/uk/book/9780241390313-the-freelance-bible/" },
            { label: "Auth.js Docs", sub: "② IN PARALLEL · Getting Started → Configuration → Providers (credentials + OAuth) → Session management · ~3 hours · add to every portfolio project · free", type: "Free", url: "https://authjs.dev/" },
            { label: "Upwork + Fiverr", sub: "③ ACTION · create profile → write a specific bio → apply to 5 jobs per day · focus on Upwork first, Fiverr second · no chapters — just do it", type: "Free", url: "https://www.upwork.com/" },
            { label: "Patrick Dang – Sales for Devs", sub: "④ WATCH · search 'freelance developer' + 'cold outreach' on his channel · focus on LinkedIn outreach and proposal writing videos · ~3 hours total · free", type: "Free", url: "https://www.youtube.com/@patrickdang" },
        ],
    },
    {
        num: "06",
        ...
        resources: [
            { label: "Shopify Dev Docs", sub: "① IF E-COMMERCE · read: Getting Started → Themes → Apps → Storefront API · follow the build-a-theme tutorial · large market, recurring work · free", type: "Free", url: "https://shopify.dev/" },
            { label: "Vercel AI SDK", sub: "② MUST LEARN · Getting Started → Generating Text → Streaming → Tool Calling · add one AI feature to every client project · ~4 hours · free", type: "Free", url: "https://sdk.vercel.ai/docs" },
            { label: "Stripe Docs", sub: "③ WHEN NEEDED · Quickstart → Checkout → Subscriptions → Webhooks → Testing · implement in your first SaaS project · ~4 hours · free", type: "Free", url: "https://stripe.com/docs" },
            { label: "Syntax Podcast", sub: "④ ONGOING · no fixed order · 2–3 episodes per week · search episodes tagged: freelance, career, React, Next.js · free", type: "Free", url: "https://syntax.fm/" },
        ],
    },
];
...
const qaFsRoadmapPhases = [
    {
        ...
        resources: [
            { label: "JavaScript: The Hard Parts", sub: "③ AFTER YDKJS · STABLE BET · watch all 4 sections: JS Principles, Closures, Async, OOP · do every coding challenge · ~6 hours total · Frontend Masters", type: "Course", url: "https://frontendmasters.com/courses/javascript-hard-parts-v2/" },
            { label: "You Don't Know JS (2nd Ed.)", sub: "② READ ALONGSIDE · STABLE BET · Book 1: Get Started (all 4 ch) · Book 2: Scope & Closures (all 6 ch) · skip the rest for now · FREE ONLINE at github.com/getify/You-Dont-Know-JS", type: "Book", url: "https://github.com/getify/You-Dont-Know-JS" },
            { label: "TypeScript Fundamentals v4", sub: "④ AFTER JS SOLID · STABLE BET · watch all sections: Basics → Interfaces → Generics → Type Guards → do all exercises · ~5 hours · start when you're halfway through javascript.info, not after", type: "Course", url: "https://frontendmasters.com/courses/typescript-v4/" },
            { label: "javascript.info + TypeScript Handbook + JS & jQuery (Duckett)", sub: "① START HERE · STABLE BET · javascript.info: ALL of Part 1 (ch 1–11) + Part 2 (ch 1–4 on browser) · TypeScript Handbook (FREE at typescriptlang.org/docs/handbook): all chapters in order · Duckett: dip in when concept doesn't click · owned/free", type: "Free", url: "https://javascript.info/" },
        ],
    },
    {
        num: "02",
        ...
        resources: [
            { label: "React Official Docs (react.dev)", sub: "① START HERE · STABLE BET · read the full 'Learn React' section: Describing the UI → Adding Interactivity → Managing State → Escape Hatches · do every challenge · ~8 hours · free", type: "Free", url: "https://react.dev/learn" },
            { label: "React – The Complete Guide", sub: "② MAIN COURSE · CURRENT BEST · watch sections 1–14 (skip Redux, it's legacy) · focus on: Components, Props, State, Hooks, useEffect, Context · ~25 hours of the course · Udemy", type: "Course", url: "https://www.udemy.com/course/react-the-complete-guide-incl-redux/" },
            { label: "Complete Intro to React v9", sub: "④ OPTIONAL SUPPLEMENT · STABLE BET · watch all sections if you use it · only pull this in if Schwarzmüller's teaching style doesn't work for you · ~7 hours · Frontend Masters", type: "Course", url: "https://frontendmasters.com/courses/complete-react-v9/" },
            { label: "TanStack Query Docs", sub: "③ AFTER HOOKS CLICK · CURRENT BEST · read: Overview → Queries → Mutations → Pagination → Optimistic Updates · skip the framework-specific sections for now · free · ~3 hours", type: "Free", url: "https://tanstack.com/query/latest/docs/framework/react/overview" },
        ],
    },
    {
        num: "03",
        ...
        resources: [
            { label: "Next.js Official Docs", sub: "① START HERE · STABLE BET · nextjs.org/learn: do the full Dashboard App tutorial (16 chapters) · then read Routing, Rendering, Data Fetching, Caching docs · ~10 hours · free", type: "Free", url: "https://nextjs.org/learn" },
            { label: "Next.js & React – Complete Guide", sub: "③ MAIN COURSE · CURRENT BEST · watch sections covering: App Router, Server Components, Data Fetching, Authentication, Deployment · skip the Pages Router sections (legacy) · ~20 hours · Udemy", type: "Course", url: "https://www.udemy.com/course/nextjs-react-the-complete-guide/" },
            { label: "Tailwind CSS From Scratch", sub: "② IN PARALLEL · CURRENT BEST · watch all sections — it's short (~6 hours) · focus on: utility classes, flexbox, grid, responsive design, dark mode · Udemy", type: "Course", url: "https://www.udemy.com/course/tailwind-from-scratch/" },
            { label: "shadcn/ui Docs", sub: "④ AS NEEDED · CURRENT BEST · read: Introduction → Installation → Theming → then look up individual components as you need them · don't read it all upfront · free", type: "Free", url: "https://ui.shadcn.com/docs" },
            { label: "Head First Design Patterns", sub: "⑤ EVENINGS · STABLE BET · ch 1 Strategy, 2 Observer, 3 Decorator, 4 Factory · map directly to React/component patterns · skip rest · YOU OWN THIS (no need to buy)", type: "Book", url: "https://www.oreilly.com/library/view/head-first-design/9781492077992/" },
        ],
    },
    {
        num: "04",
        ...
        resources: [
            { label: "Node.js: The Complete Guide", sub: "① MAIN COURSE · STABLE BET · watch: Node basics → Express → REST APIs → Authentication → File uploads → skip the GraphQL and Deno sections · ~25 hours · Udemy", type: "Course", url: "https://www.udemy.com/course/nodejs-the-complete-guide/" },
            { label: "Test-Driven Development", sub: "④ EVENINGS · STABLE BET · Part 1 ch 1–17 (Money example) + Part 2 ch 18–24 (xUnit) · skip Part 3 · YOU OWN THIS (no need to buy)", type: "Book", url: "https://www.amazon.com/Test-Driven-Development-Kent-Beck/dp/0321146530" },
            { label: "Zod Docs", sub: "② IN PARALLEL · CURRENT BEST · read: Getting Started → Primitives → Objects → Strings/Numbers → Error handling · ~2 hours · apply immediately in your API project · free", type: "Free", url: "https://zod.dev/" },
            { label: "Auth.js (NextAuth) Docs", sub: "③ AFTER AUTH SECTION · CURRENT BEST · read: Getting Started → Configuration → Providers (credentials + OAuth) → Session management · ~3 hours · free", type: "Free", url: "https://authjs.dev/" },
        ],
    },
    {
        num: "05",
        ...
        resources: [
            { label: "Complete SQL & Databases Bootcamp", sub: "① MAIN COURSE · CURRENT BEST · watch all sections through PostgreSQL · focus on: SELECT, JOINs, GROUP BY, subqueries, indexes, transactions · skip MongoDB section · ~20 hours · Udemy", type: "Course", url: "https://www.udemy.com/course/complete-sql-databases-bootcamp-zero-to-mastery/" },
            { label: "Learning SQL", sub: "④ REFERENCE · STABLE BET · ch 1–10 (querying) + ch 13 (indexes) + ch 15 (metadata) · BUY: O'Reilly or Amazon", type: "Book", url: "https://www.oreilly.com/library/view/learning-sql-3rd/9781492057604/" },
            { label: "Prisma Docs", sub: "② IN PARALLEL · CURRENT BEST · read: Getting Started → CRUD → Relations → Migrations → Filtering/Sorting · ~4 hours · start after week 2 of the SQL course, not before · free", type: "Free", url: "https://www.prisma.io/docs/getting-started" },
            { label: "Supabase Docs", sub: "③ PROJECT PHASE · CURRENT BEST · read: Database → Authentication → Storage → Edge Functions · use as your backend for the phase project · don't read upfront — reference as you build · free", type: "Free", url: "https://supabase.com/docs" },
        ],
    },
    {
        num: "06",
        ...
        resources: [
            { label: "Stripe Docs", sub: "③ WHEN BUILDING · STABLE BET · read: Quickstart → Checkout → Subscriptions → Webhooks → Testing · implement in your phase project · ~4 hours · free", type: "Free", url: "https://stripe.com/docs" },
            { label: "JavaScript Testing Practices", sub: "① START HERE · STABLE BET · watch all sections: Static Analysis → Unit Testing → Integration Testing → E2E with Playwright · do every exercise · ~8 hours · Frontend Masters", type: "Course", url: "https://frontendmasters.com/courses/testing-practices-principles/" },
            { label: "Vercel AI SDK", sub: "④ FINAL FEATURE · CURRENT BEST · read: Getting Started → Generating Text → Streaming → Tool Calling · add one AI feature to your portfolio project · ~3 hours · free", type: "Free", url: "https://sdk.vercel.ai/docs" },
            { label: "The Art of Unit Testing", sub: "② IN PARALLEL · STABLE BET · Parts 1–3 ch 1–8 (unit test → test doubles → isolation) · Part 4 optional · YOU OWN THIS (no need to buy)", type: "Book", url: "https://www.artofunittesting.com/" },
            { label: "Syntax Podcast", sub: "⑤ ONGOING · STABLE BET · no chapters to follow — just listen 2-3 episodes per week · focus on episodes tagged: TypeScript, React, Next.js, Career · free", type: "Free", url: "https://syntax.fm/" },
        ],
    },
];
...
const qaAiRoadmapPhases = [
    {
        ...
        resources: [
            { label: "Automate the Boring Stuff with Python", sub: "① START HERE · STABLE BET · chapters 1–11 (Python basics through web scraping) · do every practice project · skip ch 12–19 · YOU OWN THIS · FREE ONLINE at automatetheboringstuff.com", type: "Book", url: "https://automatetheboringstuff.com/" },
            { label: "Fluent Python", sub: "④ REFERENCE · STABLE BET · Part 1 ch 1–3 (data model + sequences) + Part 2 ch 7–9 (functions) · use as reference not a cover-to-cover read · BUY: O'Reilly or Amazon", type: "Book", url: "https://www.oreilly.com/library/view/fluent-python-2nd/9781492056348/" },
            { label: "Kaggle Learn", sub: "③ IN PARALLEL · CURRENT BEST · complete: Python track (7 lessons) + Pandas track (6 lessons) · do these in parallel with Automate · ~10 hours total · free", type: "Free", url: "https://www.kaggle.com/learn" },
            { label: "Pragmatic Thinking & Learning", sub: "② READ FIRST · STABLE BET · read chapters 1–5 (how your brain works + learning deliberately) · skip the later chapters for now · 2 hours before you start anything else · YOU OWN THIS", type: "Book", url: "https://pragprog.com/titles/ahptl/pragmatic-thinking-and-learning/" },
        ],
    },
    {
        num: "02",
        ...
        resources: [
            { label: "ML Specialization", sub: "① START HERE · STABLE BET · complete all 3 courses in the specialization · focus on: supervised learning, gradient descent, neural net basics, model evaluation · audit free on Coursera · ~60 hours", type: "Course", url: "https://www.coursera.org/specializations/machine-learning-introduction" },
            { label: "Hands-On ML", sub: "② IN PARALLEL · STABLE BET · ch 1–8 (ML fundamentals through ensemble methods) alongside Andrew Ng · ch 9–11 (neural nets) after week 4 of Ng · BUY: O'Reilly or Amazon", type: "Book", url: "https://www.oreilly.com/library/view/hands-on-machine-learning/9781098125967/" },
            { label: "fast.ai", sub: "③ AFTER WEEK 3 · STABLE BET · watch Lessons 1–7 (practical deep learning) · do all notebooks in Kaggle · start after completing Ng week 3 so you have the theory context · free", type: "Free", url: "https://course.fast.ai/" },
            { label: "Math for ML Specialization", sub: "④ AFTER NG DONE · STABLE BET · complete all 3 courses: Linear Algebra → Multivariate Calculus → PCA · only start after finishing Andrew Ng entirely · audit free", type: "Course", url: "https://www.coursera.org/specializations/mathematics-machine-learning" },
        ],
    },
    {
        num: "03",
        ...
        resources: [
            { label: "Anthropic Docs", sub: "① START HERE · STABLE BET · read in order: API reference → Models → Messages → Prompt engineering guide → Tool use → Vision → Embeddings · ~6 hours · free", type: "Free", url: "https://docs.anthropic.com/" },
            { label: "ChatGPT Prompt Engineering for Devs", sub: "② WEEK 1 · CURRENT BEST · all 9 lessons in order · it's 2 hours total · do this in your first week before anything else · free", type: "Free", url: "https://learn.deeplearning.ai/courses/chatgpt-prompt-eng-for-developers" },
            { label: "AI Engineering", sub: "④ EVENINGS · STABLE BET · ch 1–5 (foundations + RAG + agents) this phase · ch 6–9 (production + evals) in Phase 05 · BUY: O'Reilly or Amazon", type: "Book", url: "https://www.oreilly.com/library/view/ai-engineering/9781098166298/" },
            { label: "DeepLearning.AI Short Courses", sub: "③ PICK 4 · CURRENT BEST · recommended order: 1) Building RAG 2) AI Agents in LangGraph 3) Evaluating LLM outputs 4) Function calling & tool use · each is 1-2 hours · free", type: "Free", url: "https://learn.deeplearning.ai/" },
        ],
    },
    {
        num: "04",
        ...
        resources: [
            { label: "Building and Evaluating Advanced RAG", sub: "① START HERE · CURRENT BEST · all lessons in order · ~2 hours · focus on: chunking strategies, retrieval quality, reranking, evaluation · do all notebooks · free", type: "Free", url: "https://learn.deeplearning.ai/courses/building-evaluating-advanced-rag" },
            { label: "AI Agents in LangGraph", sub: "② AFTER RAG · CURRENT BEST · all lessons in order · ~3 hours · focus on: agent state, tool nodes, human-in-the-loop, multi-agent · free", type: "Free", url: "https://learn.deeplearning.ai/courses/ai-agents-in-langgraph" },
            { label: "LlamaIndex Docs", sub: "③ PROJECT PHASE · CURRENT BEST · read: Getting Started → Documents & Nodes → Indexing → Querying → Evaluating · reference as you build your project, don't read upfront · free", type: "Free", url: "https://docs.llamaindex.ai/" },
            { label: "Latent Space Podcast", sub: "④ ONGOING · STABLE BET · no fixed chapters · listen 1-2 episodes per week · focus on episodes about production AI, evals, and agent systems · free", type: "Free", url: "https://www.latent.space/" },
        ],
    },
    {
        num: "05",
        ...
        resources: [
            { label: "MLOps Specialization", sub: "① MAIN COURSE · STABLE BET · complete all 4 courses · focus on: ML pipelines, data validation, model monitoring, deployment patterns · audit free · ~50 hours", type: "Course", url: "https://www.coursera.org/specializations/machine-learning-engineering-for-production-mlops" },
            { label: "Designing ML Systems", sub: "④ EVENINGS · STABLE BET · ch 6–9 (feature engineering, training pipeline, serving, monitoring) here · ch 1–5 done in Phase 03 · BUY: O'Reilly or Amazon", type: "Book", url: "https://www.oreilly.com/library/view/designing-machine-learning/9781098107956/" },
            { label: "LLM Evaluation & Monitoring", sub: "② IN PARALLEL · CURRENT BEST · complete all modules in order · ~4 hours · build your first eval suite alongside this course · directly applicable from day one · free", type: "Free", url: "https://arize.com/llm-course/" },
            { label: "Weights & Biases Courses", sub: "③ AFTER WEEK 2 · CURRENT BEST · complete: Effective MLOps course + LLM Engineering course · ~6 hours total · start after week 2 of Andrew Ng · free", type: "Free", url: "https://www.wandb.courses/" },
        ],
    },
    {
        num: "06",
        ...
        resources: [
            { label: "Full Stack Deep Learning", sub: "① START HERE · STABLE BET · watch all lectures in order · focus on: project setup, infra, deployment, testing, UX for AI · ~15 hours · free", type: "Free", url: "https://fullstackdeeplearning.com/course/" },
            { label: "HuggingFace NLP Course", sub: "② IN PARALLEL · STABLE BET · complete chapters 1–4 (transformer basics, fine-tuning, datasets, sharing) · use the rest as reference for your chosen lane · free", type: "Free", url: "https://huggingface.co/learn/nlp-course" },
            { label: "Braintrust", sub: "③ WHEN SHIPPING · CURRENT BEST · no fixed curriculum — set up a project, define your eval criteria, run your first eval suite · their docs guide you through setup · free tier", type: "Free", url: "https://www.braintrustdata.com/" },
            { label: "Lenny's Newsletter + Latent Space", sub: "④ ONGOING · STABLE BET · Lenny's Newsletter: read every issue · Latent Space: listen 1-2 episodes per week · no fixed order — stay current · both free", type: "Free", url: "https://www.lennysnewsletter.com/" },
        ],
    },
];
