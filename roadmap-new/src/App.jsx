...
const weeks = [
  ...
  },
  {
    ...
    days: [
      { day: 1, title: "Promises basics", readUrl: "https://v2.scrimba.com/javascript-deep-dive-c0a", readLabel: "Scrimba — JS Deep Dive → secțiunea Promises", codeUrl: "https://v2.scrimba.com/javascript-deep-dive-c0a", task: "Scrie fetchUser(id) care returnează un Promise cu setTimeout. Înlănțuiește cu .then(). Adaugă .catch() la final." },
      { day: 2, title: "Promise.all & allSettled", readUrl: "https://v2.scrimba.com/javascript-deep-dive-c0a", readLabel: "Scrimba — JS Deep Dive → secțiunea Promise API", codeUrl: "https://v2.scrimba.com/javascript-deep-dive-c0a", task: "Rulează 3 Promise-uri în paralel cu Promise.all. Testează că dacă una eșuează, toate eșuează. Înlocuiește cu allSettled — observă diferența." },
      { day: 3, title: "async/await", readUrl: "https://v2.scrimba.com/javascript-deep-dive-c0a", readLabel: "Scrimba — JS Deep Dive → secțiunea async/await", codeUrl: "https://v2.scrimba.com/javascript-deep-dive-c0a", task: "Ia funcția cu .then() de ieri. Rescrie complet cu async/await și try/catch. Deschide ECapturo și rescrie un fetch cu .then() pur." },
  ...
  },
  {
    ...
    days: [
      { day: 1, title: "Componente & Props", readUrl: "https://scrimba.com/learn/learnreact", readLabel: "Scrimba — Learn React → secțiunea Components & Props", codeUrl: "https://scrimba.com/learn/learnreact", task: "Creează Button.tsx cu prop label. Randează 3 butoane diferite. Creează InvoiceCard cu props client, suma, data, isPaid." },
      { day: 2, title: "Lists & Conditional", readUrl: "https://scrimba.com/learn/learnreact", readLabel: "Scrimba — Learn React → secțiunea Lists & Conditional Rendering", codeUrl: "https://scrimba.com/learn/learnreact", task: "Randează 5 facturi cu .map() și key unic. Adaugă buton Arată doar neplătite. Dacă lista e goală, arată mesaj." },
      { day: 3, title: "useState", readUrl: "https://scrimba.com/learn/learnreact", readLabel: "Scrimba — Learn React → secțiunea useState", codeUrl: "https://scrimba.com/learn/learnreact", task: "Form cu câmpuri client și sumă controlate cu useState. La submit adaugă factura în listă. Curăță form-ul după submit." },
      ...
      { day: 5, title: "useEffect", readUrl: "https://scrimba.com/learn/learnreact", readLabel: "Scrimba — Learn React → secțiunea useEffect", codeUrl: "https://scrimba.com/learn/learnreact", task: "useEffect care loghează la fiecare render. Testează cu dependency array gol. Adaugă cleanup. Observă ordinea în consolă." },
      { day: 6, title: "Lifting state up", readUrl: "https://scrimba.com/learn/learnreact", readLabel: "Scrimba — Learn React → secțiunea Sharing State", codeUrl: "https://scrimba.com/learn/learnreact", task: "InvoiceList și InvoiceTotal ca surori. Mută state-ul în părinte. Pasează ca props. Totalul se actualizează când adaugi o factură." },
  ...
  },
  {
    ...
    days: [
      { day: 1, title: "App Router overview", readUrl: "https://scrimba.com/learn/nextjs", readLabel: "Scrimba — Learn Next.js → secțiunea App Router", codeUrl: "https://github.com/", task: "Desenează arhitectura App Router pe hârtie. Creează proiect nou. Adaugă rutele /, /facturi, /facturi/[id]. Verifică în browser." },
      { day: 2, title: "Layouts & navigare", readUrl: "https://scrimba.com/learn/nextjs", readLabel: "Scrimba — Learn Next.js → secțiunea Layouts & Navigation", codeUrl: "https://github.com/", task: "Creează layout.tsx pentru /facturi cu sidebar și linkuri Link. Fiecare pagină afișează params.id în titlu." },
      { day: 3, title: "Server vs Client Components", readUrl: "https://scrimba.com/learn/nextjs", readLabel: "Scrimba — Learn Next.js → secțiunea Server & Client Components", codeUrl: "https://github.com/", task: "Creează ServerTime (Server Component) și Counter cu useState (Client Component). Combină-le. Explică de ce ServerTime nu poate folosi useState." },
      { day: 4, title: "Data Fetching", readUrl: "https://scrimba.com/learn/nextjs", readLabel: "Scrimba — Learn Next.js → secțiunea Data Fetching", codeUrl: "https://github.com/", task: "Fetch de la jsonplaceholder.typicode.com în Server Component. Adaugă revalidate: 60. Adaugă loading.tsx și error.tsx." },
