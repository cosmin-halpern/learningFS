...
const weeks = [
  {
    ...
    days: [
      { day: 1, title: "Variabile & tipuri", readUrl: "https://javascript.info/first-steps", readLabel: "javascript.info 2.1–2.7", codeUrl: "https://jsfiddle.net/", task: "Declară variabile cu let, const, var. Scrie o funcție care primește două numere și returnează suma, diferența și produsul. Testează cu console.log." },
      { day: 2, title: "Loops & funcții", readUrl: "https://javascript.info/while-for", readLabel: "javascript.info 2.8–2.15", codeUrl: "https://jsfiddle.net/", task: "Scrie un loop care printează numerele pare de la 1 la 10. Scrie o funcție arrow și rescrie-o ca function declaration." },
      { day: 3, title: "Objects", readUrl: "https://javascript.info/object", readLabel: "javascript.info 4.1–4.4", codeUrl: "https://jsfiddle.net/", task: "Creează un obiect factura cu id, client, suma, data. Adaugă o metodă descriere(). Creează 3 facturi într-un array." },
      { day: 4, title: "Arrays — map, filter, reduce", readUrl: "https://javascript.info/array-methods", readLabel: "javascript.info 5.1–5.3", codeUrl: "https://jsfiddle.net/", task: "Din array-ul de facturi: filter() facturi > 500 RON, map() pentru nume clienți, reduce() pentru total. Înlănțuiește toate trei." },
      { day: 5, title: "Destructuring & Spread", readUrl: "https://javascript.info/destructuring-assignment", readLabel: "javascript.info 5.4–5.7", codeUrl: "https://jsfiddle.net/", task: "Destructurează o factură. Creează un Set care elimină duplicatele. Combină două array-uri cu spread operator." },
      { day: 6, title: "Optional chaining & Nullish", readUrl: "https://javascript.info/optional-chaining", readLabel: "javascript.info 4.5–4.8", codeUrl: "https://jsfiddle.net/", task: "Testează user?.adresa?.oras pe un obiect fără adresă. Scrie const port = config?.port ?? 3000. Copiază un obiect cu spread: {...factura, suma: 999}." },
  ...
  },
  {
    ...
    days: [
      { day: 1, title: "Closures", readUrl: "https://javascript.info/closure", readLabel: "javascript.info 6.1–6.3", codeUrl: "https://jsfiddle.net/", task: "Scrie makeCounter() care returnează o funcție. La fiecare apel contorul crește. Creează 2 contoare independente și verifică că sunt separate." },
      { day: 2, title: "this & binding", readUrl: "https://javascript.info/bind", readLabel: "javascript.info 6.4–6.6", codeUrl: "https://jsfiddle.net/", task: "Creează un obiect cu metoda start(). Pune-o în setTimeout — observă că this dispare. Repară cu arrow function și alternativ cu .bind(this)." },
      { day: 3, title: "Decorators", readUrl: "https://javascript.info/call-apply-decorators", readLabel: "javascript.info 6.7–6.9", codeUrl: "https://jsfiddle.net/", task: "Scrie delay(fn, ms) care returnează o versiune întârziată a funcției. Testează: const log = delay(console.log, 1000). Apelează și verifică." },
      { day: 4, title: "Memoization", readUrl: "https://javascript.info/call-apply-decorators", readLabel: "JS Definitive Guide cap. 8", codeUrl: "https://jsfiddle.net/", task: "Scrie memoize(fn) care cachează rezultatele. Al doilea apel cu aceiași parametri trebuie să returneze instantaneu din cache." },
      ...
      { day: 6, title: "Repetare punct slab", readUrl: "https://javascript.info/closure", readLabel: "Reia ziua unde ai greșit", codeUrl: "https://jsfiddle.net/", task: "Reia exercițiul cu care te-ai blocat cel mai mult săptămâna asta. Scrie-l din memorie fără să te uiți la soluție." },
  ...
  },
  {
    ...
    days: [
      { day: 1, title: "Promises basics", readUrl: "https://javascript.info/promise-basics", readLabel: "javascript.info 11.1–11.3", codeUrl: "https://jsfiddle.net/", task: "Scrie fetchUser(id) care returnează un Promise cu setTimeout. Înlănțuiește cu .then(). Adaugă .catch() la final." },
      { day: 2, title: "Promise.all & allSettled", readUrl: "https://javascript.info/promise-api", readLabel: "javascript.info 11.4–11.5", codeUrl: "https://jsfiddle.net/", task: "Rulează 3 Promise-uri în paralel cu Promise.all. Testează că dacă una eșuează, toate eșuează. Înlocuiește cu allSettled — observă diferența." },
      { day: 3, title: "async/await", readUrl: "https://javascript.info/async-await", readLabel: "javascript.info 11.6–11.7", codeUrl: "https://jsfiddle.net/", task: "Ia funcția cu .then() de ieri. Rescrie complet cu async/await și try/catch. Deschide ECapturo și rescrie un fetch cu .then() pur." },
      { day: 4, title: "Error handling async", readUrl: "https://javascript.info/async-await", readLabel: "javascript.info 11.8", codeUrl: "https://jsfiddle.net/", task: "Scrie fetchAll(urls) în paralel. Dacă oricare eșuează, continuă cu celelalte. Returnează [{url, data, error}] pentru fiecare." },
  ...
  },
  {
    ...
    days: [
      { day: 1, title: "Componente & Props", readUrl: "https://react.dev/learn/your-first-component", readLabel: "react.dev — First Component", codeUrl: "https://codesandbox.io/", task: "Creează Button.tsx cu prop label. Randează 3 butoane diferite. Creează InvoiceCard cu props client, suma, data, isPaid." },
      { day: 2, title: "Lists & Conditional", readUrl: "https://react.dev/learn/rendering-lists", readLabel: "react.dev — Lists + Conditional", codeUrl: "https://codesandbox.io/", task: "Randează 5 facturi cu .map() și key unic. Adaugă buton Arată doar neplătite. Dacă lista e goală, arată mesaj." },
      { day: 3, title: "useState", readUrl: "https://react.dev/learn/state-a-components-memory", readLabel: "react.dev — useState", codeUrl: "https://codesandbox.io/", task: "Form cu câmpuri client și sumă controlate cu useState. La submit adaugă factura în listă. Curăță form-ul după submit." },
      { day: 4, title: "State as snapshot", readUrl: "https://react.dev/learn/state-as-a-snapshot", readLabel: "react.dev — State as snapshot", codeUrl: "https://codesandbox.io/", task: "Buton care face setCount(count+1) de 3 ori. Observă că adaugă 1. Repară cu setCount(c => c+1). Explică de ce." },
      { day: 5, title: "useEffect", readUrl: "https://react.dev/learn/synchronizing-with-effects", readLabel: "react.dev — useEffect", codeUrl: "https://codesandbox.io/", task: "useEffect care loghează la fiecare render. Testează cu dependency array gol. Adaugă cleanup. Observă ordinea în consolă." },
      { day: 6, title: "Lifting state up", readUrl: "https://react.dev/learn/sharing-state-between-components", readLabel: "react.dev — Sharing state", codeUrl: "https://codesandbox.io/", task: "InvoiceList și InvoiceTotal ca surori. Mută state-ul în părinte. Pasează ca props. Totalul se actualizează când adaugi o factură." },
  ...
  },
  {
    ...
    days: [
      { day: 1, title: "App Router overview", readUrl: "https://nextjs.org/docs/app/building-your-application/routing", readLabel: "Next.js docs — Routing", codeUrl: "https://github.com/", task: "Desenează arhitectura App Router pe hârtie. Creează proiect nou. Adaugă rutele /, /facturi, /facturi/[id]. Verifică în browser." },
      { day: 2, title: "Layouts & navigare", readUrl: "https://nextjs.org/docs/app/building-your-application/routing/layouts-and-templates", readLabel: "Next.js docs — Layouts", codeUrl: "https://github.com/", task: "Creează layout.tsx pentru /facturi cu sidebar și linkuri Link. Fiecare pagină afișează params.id în titlu." },
      { day: 3, title: "Server vs Client Components", readUrl: "https://nextjs.org/docs/app/building-your-application/rendering/server-components", readLabel: "Next.js docs — Server & Client", codeUrl: "https://github.com/", task: "Creează ServerTime (Server Component) și Counter cu useState (Client Component). Combină-le. Explică de ce ServerTime nu poate folosi useState." },
      { day: 4, title: "Data Fetching", readUrl: "https://nextjs.org/docs/app/building-your-application/data-fetching", readLabel: "Next.js docs — Data Fetching", codeUrl: "https://github.com/", task: "Fetch de la jsonplaceholder.typicode.com în Server Component. Adaugă revalidate: 60. Adaugă loading.tsx și error.tsx." },
      { day: 5, title: "API Routes", readUrl: "https://nextjs.org/docs/app/building-your-application/routing/route-handlers", readLabel: "Next.js docs — Route Handlers", codeUrl: "https://github.com/", task: "Creează /api/facturi/route.ts. GET returnează array mock. POST validează client și suma. Dacă suma lipsește returnează 400." },
      { day: 6, title: "Server Actions", readUrl: "https://nextjs.org/docs/app/building-your-application/data-fetching/server-actions-and-mutations", readLabel: "Next.js docs — Server Actions", codeUrl: "https://github.com/", task: "Convertește un API route POST simplu într-un Server Action. Apelează direct din componentă. Adaugă revalidatePath." },
